        ...
        if($_SESSION["role"] == "admin"){
            ...
            if(isset($_POST["search_page"])){
                if(isset($_POST['terme_page'])){
                    ...
                    $req_site = $db->query("SELECT * FROM page_modele where nom like '%$val%'");    
                }
            }
    ...
    <div class="container">
                ...
                <form method="POST">
                    <div class="d-flex justify-content-end w-50 float-end mb-3 mt-3 ">
                        <input class="form-control me-1 ms-2" name="terme_page" type="search" placeholder="Rechercher une page" aria-label="Search">
...
<?php
                                foreach ($data_pages as $page) {
                                    ...
                                    $nbImg = $req_nbImg->fetchColumn();
                                    $nbTxt = $req_nbTxt->fetchColumn();
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a class="dropdown-item actionAdmin" href="../images-modele/index.php?site_id=<?=$page['id_pageM']?>">Voir les images</a></li>
                                            <li><a class="dropdown-item actionAdmin" href="../textes-modele/index.php?site_id=<?=$page['id_pageM']?>">Voir les textes</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
